...
<head>
    ...
    <title>Reporte de Examen Ocupacional - {{ $patientFullName }} - {{ $date }}</title>
    <style>
        @page {
            size: A4;
            margin: 2cm 1.5cm;
...
<body>
    <div class="header no-break">
        ...
        <div class="info">
            <strong>REGISTRO DE EXÁMENES MÉDICOS OCUPACIONALES</strong><br>
            Emitido: {{ now()->format('d/m/Y h:i a') }}
        </div>
    </div>

    <div class="section">
        <div class="section-title">Información del Examen</div>
        <table>
            <tr>
