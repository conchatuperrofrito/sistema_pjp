...
<head>
    ...
    <title>Reporte de Monitoreo Ambiental - {{ $area }} - {{ $measurementDate }}</title>
    <style>
...
<body>
    <div class="header no-break">
        ...
        <div class="info">
            <strong>REGISTRO DE MONITOREOS AMBIENTALES Y AGENTES DE RIESGO</strong><br>
            Emitido: {{ now()->format('d/m/Y h:i a') }}
        </div>
    </div>

    <div class="section">
        <div class="section-title">Información del Monitoreo</div>
        <table>
            <tr>
                <th>Área</th>
                <td>{{ $area }}</td>
            ...
            <tr>
                <th>Descripción del Agente</th>
                <td>{{ $agentDescription }}</td>
            </tr>
            <tr>
                <th>Valor Medido</th>
                <td>{{ $measuredValue }} {{ $unit }}</td>
            </tr>
            <tr>
                <th>Límite Permitido</th>
                <td>{{ $permittedLimit ? $permittedLimit . ' ' . $unit : 'No especificado' }}</td>
            </tr>
            <tr>
                <th>Frecuencia</th>
                <td>{{ $frequency }}</td>
